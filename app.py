...
protein_page = st.Page("pages/Protein_Import.py", title="Protein Upload", icon="🧬")
peptide_page = st.Page("pages/Peptide_Import.py", title="Peptide Upload", icon="🧬")
quality_page = st.Page("pages/Data_Quality.py", title="Data Quality", icon="📊", default=True)
