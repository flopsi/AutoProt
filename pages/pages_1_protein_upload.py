"""
Protein-Level Data Upload Page
"""
...
st.caption("Import and configure protein-level quantification data")
...
# Button with proper behavior (no session state needed - follows Streamlit best practices)
...
if SessionKeys.PROTEIN_DATASET.value in st.session_state:
    ...
    st.info("✨ **Next Step:** Go to the Analysis page or upload peptide-level data for enhanced statistics.")
